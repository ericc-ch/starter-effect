...
/**
 * Groups related menu items together. Required when using `DropdownMenuLabel`
 * since Base UI's `Menu.GroupLabel` must be inside a `Menu.Group`.
 *
 * @example
 * ```tsx
 * <DropdownMenuContent>
...
/**
 * A label for a group of menu items. Must be used inside `DropdownMenuGroup`.
 */
